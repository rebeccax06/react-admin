...
import RecieptOutlinedIcon from "@mui/icons-material/LightModeOutlined";
...
import PieChartOutlineOutlinedIcon from "@mui/icons-material/LightModeOutlined";
...
const Item = ({title, to, icon, selected, setSelected}) => {
    ...
    return (
        <MenuItem active = {selected ===title} style= {{colors: colors.grey[100]}} onClick = {() => setSelected(title)} icon = {icon}>
...
const Sidebar = () => {
    const theme = useTheme();
    const colors = tokens(theme.palette.mode);
    //whether sidebar collapsed or not
    const [isCollapsed, setIsCollapsed] = useState(false);
    //what page currently at
    const [selected, setSelected] = useState("Dashboard");
    return (
        <Box
            sx = {{
                // selecting css + styling
                "& .pro-sidebar-inner": {
                    ...
                    {!isCollapsed && (
                        <Box mb = "25px">
                            ...
                            <Box textAlign = "center">
                                <Typography variant = "h2" color = {colors.grey[100]} fontWeight = "bold" sx = {{m: "10px 0 0 0"}}>Rebecca</Typography>
                                <Typography variant = "h5" color = {colors.greenAccent[500]}>Student VP</Typography>
                            </Box>
                        </Box>
